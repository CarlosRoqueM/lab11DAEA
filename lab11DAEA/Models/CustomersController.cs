...
namespace lab11DAEA.Models
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,firstName,lastName,documentNumber")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,firstName,lastName,documentNumber")] Customer customer)
        {
            if (id != customer.id)
            {
                return NotFound();
